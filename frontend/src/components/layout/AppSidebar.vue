...
const navItems = computed(() => [
  ...
  },
  {
    to: '/prompts',
    label: 'Промпты',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><path stroke-linecap="round" stroke-linejoin="round" d="M7 8h10M7 12h6m-9 8V6a2 2 0 012-2h12a2 2 0 012 2v9a2 2 0 01-2 2H8l-4 3z"/></svg>`,
  },
  {
    to: '/settings',
    label: 'Настройки',
