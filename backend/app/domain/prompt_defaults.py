...
_WRITING_PARAGRAPH_INSTRUCTIONS = PromptDefaultEntry(
    ...
    template_text=(
        ...
        "- title — точный заголовок без кликбейта и недоказанных обещаний.\n"
        "- cover_title — 2–5 слов ЗАГЛАВНЫМИ для обложки (напр. «ЖУК СТРЕЛЯЕТ КИПЯТКОМ»).\n"
        "- hook — 1–2 предложения: сразу событие/противоречие/факт. БЕЗ эмодзи в начале.\n"
        ...
        "\n"
        "image_prompt — 3–4 предложения НА АНГЛИЙСКОМ: иллюстрация БЕЗ текста.\n"
        "Конкретные объекты, текстуры, свет. Запрещено: люди/лица, любой текст/буквы/цифры\n"
        "на картинке, UI, водяные знаки.\n"
...
_IMAGE_WRITER_HINT_PARAGRAPH = PromptDefaultEntry(
    ...
    template_text=(
        "Поле image_prompt: 3–4 предложения НА АНГЛИЙСКОМ — визуальная сцена по теме "
        "без людей и без любого текста на изображении. Конкретные объекты, материалы, "
        "свет. Текст заголовка на обложку наложит платформа отдельно (cover_title)."
    ),
    channel_scope="paragraph",
    sort_order=30,
)
...
_IMAGE_COVER_PROMPT = PromptDefaultEntry(
    ...
    template_text=(
        "Create a dramatic cinematic editorial illustration for a science/history story.\n"
        "\n"
        "Story context: {summary}\n"
        "Reference title (DO NOT render as text): {title}\n"
        "\n"
        "Requirements:\n"
        "1. Wide 16:9 landscape.\n"
        "2. One strong visual metaphor — concrete objects, materials, depth, lighting.\n"
        "3. Absolutely NO text, letters, numbers, captions, logos, watermarks, UI.\n"
        "4. No people, faces, or body parts.\n"
        "5. Clean composition with space in the lower third for later title overlay.\n"
        "6. Photorealism or high-quality 3D render, rich detail, no cluttered micro-labels."
    ),
