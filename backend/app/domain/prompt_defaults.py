...
_WRITING_PARAGRAPH_INSTRUCTIONS = PromptDefaultEntry(
    ...
    template_text=(
        ...
        "  Выбор по главной теме (не по «накалу» истории):\n"
        "  #авиация — самолёты, аэродинамика, авиация, аэропорты;\n"
        "  #катастрофы — ТОЛЬКО аварии/крушения/техногенные катастрофы как суть поста\n"
        "    (обычно вместе с category=error). НЕ ставь на историю, вулканы, экологию,\n"
        "    открытия, изобретения, просто драматичный сюжет;\n"
        "  #физика — физические явления, законы, эксперименты, материалы;\n"
        "  #космос — космос, планеты, спутники, астрономия;\n"
        "  #технологии — инженерия, изобретения, гаджеты, промышленность, IT.\n"
        "  Пример: винглеты → [\"#авиация\", \"#физика\"]; баг с мотыльком → [\"#технологии\"].\n"
